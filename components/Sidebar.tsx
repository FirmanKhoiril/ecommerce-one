...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className={`fixed max-w-[280px] sm:max-w-xs w-full top-[60px] ${activeSidebar ? "translate-x-[0%]" : "translate-x-[-100%]"} transition duration-300 z-20 h-screen left-0 bg-white py-4 px-2`}>Sidebar</aside>
    </>
  );
};
