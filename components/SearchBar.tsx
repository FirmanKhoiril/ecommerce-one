...
const SearchBar = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className={` flex flex-grow items-center justify-center relative`}>
      ...
      />
      <button className=" p-[9px] peer-focus:bg-primary/80 hover:bg-primary/80 shadow-md text-white transition duration-[0.4s] rounded-r-lg bg-primary" aria-label="buttonSearch" type="submit">
