...
const Card = ({ name, price, normalPrice, city, image, discount, slug: { current } }: ICardProduct) => {
  return (
    <div className="w-[160px] md:w-[170px] bg-white hover:translate-y-[-4px] group transition duration-300 rounded-lg relative hover:border-blue-500/60 border border-transparent h-auto pb-2 drop-shadow-sm hover:drop-shadow-lg">
