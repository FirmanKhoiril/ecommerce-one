...
const Card = ({ name, price, normalPrice, city, image, discount, slug: { current } }: ICardProduct) => {
  return (
    <div className="w-[160px] bg-white hover:translate-y-[-4px] transition duration-300  relative hover:border-blue-500/60 border overflow-hidden border-transparent h-auto pb-2 drop-shadow-sm hover:drop-shadow-lg">
      ...
      <Button
        ...
        label="tambahkanCart"
        type="button"
        className="p-2 hover:bg-blue-100 rounded-full bg-white text-black absolute transition duration-300 top-1 right-1 z-10 shadow-black/20 shadow-[2px_2px_2px_2px]"
      />
    </div>
  );
};
